...
public record CommitOffsetPayload(String groupId, String topic, int partition, long offset) {
    ...
    public byte[] encode() {
        try {
            ...
            throw new RuntimeException("Failed to encode commit offset payload", e);
        }
    }
    public static CommitOffsetPayload decode(byte[] bytes) {
        try {
            ...
            return new CommitOffsetPayload(groupId, topic, partition, offset);
        } catch (IOException e) {
            throw new RuntimeException("Failed to decode commit offset payload", e);
        }
    }
}