...
public record FetchOffsetPayload(
        String groupId,
        String topic,
        int partition
) {
    ...
    public byte[] encode() {
        ...
        try {
            ...
            throw new RuntimeException(
                    "Failed to encode fetch offset payload",
                    e
            );
        }
    }

    public static FetchOffsetPayload decode(
            byte[] bytes) {
        ...
        try {
            ...
            throw new RuntimeException(
                    "Failed to decode fetch offset payload",
                    e
            );
        }
    }
