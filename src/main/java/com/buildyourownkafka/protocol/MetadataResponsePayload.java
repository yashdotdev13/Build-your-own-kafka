...
public record MetadataResponsePayload(
        String topicName,
    ...
    public MetadataResponsePayload {
        ...
        if (partitionIds == null || partitionIds.isEmpty()) {
            throw new IllegalArgumentException(
                    "Partition list cannot be null or empty"
            );
        }
    ...
    public byte[] encode() {
        ...
        try {
            ...
            throw new IllegalStateException(
                    "Failed to encode METADATA response",
                    e
            );
        }
    }
    ...
    public static MetadataResponsePayload decode(byte[] bytes) {
        ...
        try {
            ...
            if (data.available() != 0) {
                throw new IllegalArgumentException(
                        "Unexpected trailing bytes in METADATA response"
                );
            }

            return new MetadataResponsePayload(
                    topicName,
                    partitionIds
            );
            ...
            throw new IllegalArgumentException(
                    "Invalid METADATA response payload",
                    e
            );
        } catch (IOException e) {
            throw new IllegalArgumentException(
                    "Failed to decode METADATA response payload",
                    e
            );
        }
    }
