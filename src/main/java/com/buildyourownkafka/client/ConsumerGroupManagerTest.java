...
public class ConsumerGroupManagerTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "=== CONSUMER GROUP MANAGER TEST ==="
        );

        ConsumerGroupManager manager =
                new ConsumerGroupManager();

        ConsumerGroup paymentGroup =
                manager.getOrCreateGroup(
                        "payment-service"
                );
        ...
        ConsumerGroup analyticsGroup =
                manager.getOrCreateGroup(
                        "analytics-service"
                );

        GroupMember consumer3 =
                new GroupMember(
                        "consumer-3",
                        "analytics-service",
                        0,
        ...
        if (!manager.groupExists(
                "payment-service"
        )) {

            throw new RuntimeException(
                    "Payment group should exist"
            );
        }
         ...
         * Remove consumer-2.
         *
         * The group should now be removed.
         */
        ...
        if (manager.groupExists(
            ...
            throw new RuntimeException(
                    "Empty consumer group should be removed"
            );
        }
        ...
        if (!manager.groupExists(
            ...
            throw new RuntimeException(
                    "Analytics group should still exist"
            );
        }
        ...
        System.out.println(
                "ConsumerGroupManager verified successfully!"
        );
    }
}