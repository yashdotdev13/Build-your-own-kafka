...
public class SyncGroupRequestPayloadTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("=== SYNC GROUP REQUEST PAYLOAD TEST ===");
        SyncGroupRequestPayload original = new SyncGroupRequestPayload("orders-group", "consumer-A", 0);
        byte[] encoded = original.encode();
        System.out.println("Encoded payload size: " + encoded.length);
        SyncGroupRequestPayload decoded = SyncGroupRequestPayload.decode(encoded);
        ...
        System.out.println();
        System.out.println("SYNC_GROUP request payload " + "verified successfully!");
    }
}