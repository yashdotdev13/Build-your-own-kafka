...
public class PartitionAssignerTest {
    ...
    public static void main(String[] args) {
        ...
        /*
         * Because members are sorted internally:
         *
         * consumer-A -> [0, 2]
         * consumer-B -> [1, 3]
         */
        ...
        if (assignment.partitionCount()
            ...
            throw new RuntimeException(
                    "Expected all 4 partitions to be assigned"
            );
        }
         ...
         *
         * Reverse member order again.
         */

        PartitionAssignment secondAssignment =
                assigner.assign(
                        List.of(
                                "consumer-A",
                                "consumer-B"
        ...
        if (!unevenAssignment
            ...
            throw new RuntimeException(
                    "Incorrect assignment for consumer-C"
            );
        }
        ...
        if (!unevenAssignment
                .partitionsFor("consumer-E")
                .isEmpty()) {

            throw new RuntimeException(
                    "consumer-E should have no partitions"
            );
        }

        System.out.println();
        System.out.println(
                "PartitionAssigner verified successfully!"
        );
    }
}