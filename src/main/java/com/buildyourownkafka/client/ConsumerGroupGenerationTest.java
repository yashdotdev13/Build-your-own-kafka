...
public class ConsumerGroupGenerationTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "=== CONSUMER GROUP GENERATION TEST ==="
        );
        ...
        System.out.println(
                "Generation after first increment: "
                        + generation1
        );
        ...
        System.out.println(
                "Generation after second increment: "
                        + generation2
        );
        ...
        if (group.generation() != 2) {
            throw new AssertionError(
                    "Group generation was not updated"
            );
        }

        /*
         * Verify members can still exist normally.
         */
