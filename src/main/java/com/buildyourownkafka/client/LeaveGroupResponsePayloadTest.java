...
public class LeaveGroupResponsePayloadTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("=== LEAVE GROUP RESPONSE PAYLOAD TEST ===");
        LeaveGroupResponsePayload original = new LeaveGroupResponsePayload("consumer-A");
        byte[] encoded = original.encode();
        System.out.println("Encoded payload size: " + encoded.length);
        LeaveGroupResponsePayload decoded = LeaveGroupResponsePayload.decode(encoded);
        ...
        System.out.println();
        System.out.println("LEAVE_GROUP response payload " + "verified successfully!");
    }
}