...
public record SyncGroupRequestPayload(String groupId, String memberId, int generation) {
    ...
    public static SyncGroupRequestPayload decode(byte[] payload) throws IOException {
        if (payload == null) {
        ...
        return new SyncGroupRequestPayload(groupId, memberId, generation);
    }
}