...
public record LeaveGroupResponsePayload(String memberId) {
    ...
    public static LeaveGroupResponsePayload decode(byte[] payload) throws IOException {
        ...
        return new LeaveGroupResponsePayload(memberId);
    }
}