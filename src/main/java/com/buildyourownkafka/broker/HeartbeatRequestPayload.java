...
public record HeartbeatRequestPayload(String groupId, String memberId, int generation) {
    ...
    public static HeartbeatRequestPayload decode(byte[] payload) throws IOException {
        ...
        return new HeartbeatRequestPayload(groupId, memberId, generation);
    }
}